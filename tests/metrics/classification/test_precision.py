...
from torcheval.metrics.classification import Precision
...
class TestPrecision(MetricClassTester):
    def _test_precision_class_with_input(
        ...
        if num_classes is None:
            if average == "micro":
                ...
                self.run_class_implementation_tests(
                    metric=Precision(average=average),
                    state_names={"num_tp", "num_fp", "num_label"},
                    update_kwargs={
                        "input": input,
                        "target": target,
            ...
            if average == "micro":
                self.run_class_implementation_tests(
                    metric=Precision(num_classes=num_classes),
                    state_names={"num_tp", "num_fp", "num_label"},
                    update_kwargs={
                        "input": input,
                        "target": target,
                ...
                self.run_class_implementation_tests(
                    metric=Precision(num_classes=num_classes, average=average),
                    state_names={"num_tp", "num_fp", "num_label"},
                    update_kwargs={
                        "input": input,
                        "target": target,
    ...
    def test_precision_class_invalid_input(self) -> None:
        with self.assertRaisesRegex(
            ...
            Precision(num_classes=2, average="gaussian")
